...
function ProductDetail() {
    ...
    return (
        <div className="lg:mx-30 lg:mt-10 flex flex-col justify-center md:flex-row md:gap-10 md:p-5">
            <img src={product.thumbnail} alt="" className="w-full md:w-1/3 object-cover rounded" />
